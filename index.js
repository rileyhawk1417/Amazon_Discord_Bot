...
client.on('ready', () => {
    ...
    client.user.setActivity("User Search", {
        type: "WATCHING"
    });
    ...
    if (command === 'product') {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            if (!!list.products[i].price) {
                ...
                let productLink = 'https://www.amazon.com' + list.products[i].url;
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .addFields({
                        name: 'Product Name',
                        value: trim(productName, 1024)
                    }, {
                        name: 'Price',
                        value: trim(productPrice, 1024)
                    }, {
                        name: 'Rating',
                        value: trim(productRating, 1024)
                    }, {
                        name: 'Reviews',
